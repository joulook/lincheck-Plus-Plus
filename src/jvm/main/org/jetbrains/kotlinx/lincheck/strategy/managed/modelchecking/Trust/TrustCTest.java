...
import static org.jetbrains.kotlinx.lincheck.strategy.managed.ManagedCTestConfiguration.DEFAULT_INVOCATIONS;

/**
 * This annotation configures concurrent test using {@link TrustStrategy managed} strategy.
 */

@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
@Repeatable(TrustCTest.TrustCTests.class)
@Inherited
public @interface TrustCTest {
     ...
     * the obstruction-freedom violation if {@link TrustCTest#checkObstructionFreedom} is enabled.
     */
    ...
    /**
     * Holder annotation for {@link TrustCTest}.
     */
    @Retention(RetentionPolicy.RUNTIME)
    @Target(ElementType.TYPE)
    @Inherited
    @interface TrustCTests {
        TrustCTest[] value();
    }
}
